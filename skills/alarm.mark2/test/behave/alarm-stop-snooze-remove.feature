Feature: Alarm - Stop, snooze, and remove
  ...
  Scenario Outline: user deletes all alarms
    Given an english speaking user
     ...
     Then "alarm.mark2" should reply with dialog from "cancelled-multiple.dialog"
  ...
  #    Then "alarm.mark2" should stop beeping and start beeping again 10 minutes
  ...
  #    Then "alarm.mark2" should stop beeping and start beeping again 5 minutes
  ...
  #    Then "alarm.mark2" should reply with dialog from "cancelled-single.dialog"
  #    Then alarms are stopped
...
#      And an alarm is set for 10:00 pm next friday
#      When the user says "<delete alarm>"
#      Then "alarm.mark2" should reply with dialog from "ask-which-alarm-delete.dialog"
#      And the user says "9:00 am"
#      And "alarm.mark2" should reply with dialog from "cancelled-single.dialog"

Feature: Mycroft Weather Skill local forecasted temperatures
  ...
  Scenario Outline: What is the temperature for tomorrow
    Given an english speaking user
     ...
     Then "weather.mark2" should reply with dialog from "daily-temperature-local.dialog"
  ...
  Scenario Outline: what is the high temperature for tomorrow
    Given an english speaking user
     ...
     Then "weather.mark2" should reply with dialog from "daily-temperature-high-local.dialog"
  ...
  Scenario Outline: what is the low temperature for tomorrow
    Given an english speaking user
     ...
     Then "weather.mark2" should reply with dialog from "daily-temperature-low-local.dialog"
  ...
  Scenario Outline: what is the temperature at a certain time
    Given an english speaking user
     ...
     Then "weather.mark2" should reply with dialog from "hourly-temperature-local.dialog"

...
class SkillExample(MycroftSkill):
    ...
    def initialize(self):
        ...
        self.gui.register_handler(
            "skillExample.simpleText", self.handle_gui_example_one_intent
        )
        self.gui.register_handler(
            "skillExample.simpleImage", self.handle_gui_example_two_intent
        )
        self.gui.register_handler(
            "skillExample.paginatedText", self.handle_gui_example_three_intent
        )
        self.gui.register_handler(
            "skillExample.slidingImage", self.handle_gui_example_four_intent
        )
        self.gui.register_handler(
            "skillExample.proportionalDelegate", self.handle_gui_example_five_intent
        )
        self.gui.register_handler(
            "skillExample.listView", self.handle_gui_example_six_intent
        )
        self.gui.register_handler(
            "skillExample.eventsExample", self.handle_gui_example_seven_intent
        )
    ...
    def handle_gui_example_one_intent(self, message):
        ...
        """
        self.gui.show_text(
            "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec placerat varius turpis porta scelerisque. Nam feugiat, lectus a ultricies tempus, mi sem tempor felis, vitae laoreet nisi ipsum vitae mauris."
        )
